id: 12
source: 1
name: InheritResourceGroup
description: 'Simple plugin that checks if the resource has a parent that is part of a resource group and automatically adds the child resource to this resource group.'
properties: 'a:0:{}'
